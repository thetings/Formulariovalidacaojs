class Validator {
    ...
    validate(form) {
      ...
      let currentValidations = document.querySelectorAll('form .erro_validacao');
    ...
    onlyletters(input) {
      ...
      let errorMessage = `Somente letras`;
    ...
    emailvalidate(input) {
      ...
      let errorMessage = `Tente um e-mail valido: exemplo@exemplo.com.br`;
    ...
    equal(input, inputName) {
      ...
      let errorMessage = `As senhas não coincidem`;
    ...
    passwordvalidate(input) {
      ...
      if(uppercases === 0 || numbers === 0) {
        let errorMessage = `A senha prescisa conter letra maiúscula e números`;
    ...
    printMessage(input, msg) {
      ...
      let errorsQty = input.parentNode.querySelector('.erro_validacao');
